...
type LoginResponse struct {
	...
	NombreCompleto string                 `protobuf:"bytes,5,opt,name=nombre_completo,json=nombreCompleto,proto3" json:"nombre_completo,omitempty"`
...
func (x *LoginResponse) GetNombreCompleto() string {
	if x != nil {
...
func (x *LoginResponse) GetTelefono() string {
	if x != nil {
		return x.Telefono
	}
	return ""
...
func (x *ValidateTokenResponse) GetRol() string {
	if x != nil {
		return x.Rol
	}
	return ""
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x0fnombre_completo\x18\x05 \x01(\tR\x0enombreCompleto\x12\x1a\n" +
	"\btelefono\x18\x06 \x01(\tR\btelefono\"C\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB\x15Z\x13delivery-proto/authb\x06proto3"
