...
const file_orderpb_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x1f.order.CancelledOrRejectedOrderR\x06orders2\xdc\a\n" +
	"\fOrderService\x12D\n" +
	...
	"\rGetOrderImage\x12\x1b.order.GetOrderImageRequest\x1a\x1c.order.GetOrderImageResponseB\x18Z\x16delivery-proto/orderpbb\x06proto3"
...
var file_orderpb_order_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
var file_orderpb_order_proto_depIdxs = []int32{
	...
	5,  // 5: order.OrderService.CancelOrder:input_type -> order.CancelOrderRequest
	8,  // 6: order.OrderService.GetOrdersByClient:input_type -> order.GetOrdersByClientRequest
	9,  // 7: order.OrderService.GetOrdersByRestaurant:input_type -> order.GetOrdersByRestaurantRequest
	11, // 8: order.OrderService.AssignDriver:input_type -> order.AssignDriverRequest
	13, // 9: order.OrderService.GetFinishedOrders:input_type -> order.GetFinishedOrdersRequest
	14, // 10: order.OrderService.GetDeliveredOrders:input_type -> order.GetDeliveredOrdersRequest
	15, // 11: order.OrderService.GetCancelledOrRejectedOrders:input_type -> order.GetCancelledOrdersRequest
	16, // 12: order.OrderService.GetOrdersByDriver:input_type -> order.GetOrdersByDriverRequest
	17, // 13: order.OrderService.AddOrderImage:input_type -> order.AddOrderImageRequest
	19, // 14: order.OrderService.GetOrderImage:input_type -> order.GetOrderImageRequest
	2,  // 15: order.OrderService.CreateOrder:output_type -> order.CreateOrderResponse
	4,  // 16: order.OrderService.UpdateOrderStatus:output_type -> order.UpdateOrderStatusResponse
	6,  // 17: order.OrderService.CancelOrder:output_type -> order.CancelOrderResponse
	10, // 18: order.OrderService.GetOrdersByClient:output_type -> order.GetOrdersResponse
	10, // 19: order.OrderService.GetOrdersByRestaurant:output_type -> order.GetOrdersResponse
	12, // 20: order.OrderService.AssignDriver:output_type -> order.AssignDriverResponse
	10, // 21: order.OrderService.GetFinishedOrders:output_type -> order.GetOrdersResponse
	10, // 22: order.OrderService.GetDeliveredOrders:output_type -> order.GetOrdersResponse
	22, // 23: order.OrderService.GetCancelledOrRejectedOrders:output_type -> order.GetCancelledOrRejectedOrdersResponse
	10, // 24: order.OrderService.GetOrdersByDriver:output_type -> order.GetOrdersResponse
	18, // 25: order.OrderService.AddOrderImage:output_type -> order.AddOrderImageResponse
	20, // 26: order.OrderService.GetOrderImage:output_type -> order.GetOrderImageResponse
